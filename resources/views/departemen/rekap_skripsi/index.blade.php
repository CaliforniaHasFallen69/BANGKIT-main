...
<div class="card bg-body-tertiary table-responsive" id="rekap-skripsi-main">
  ...
  <table class="table-bordered text-center rounded">
    ...
    <tr>
      @for ($i = $current_year - 6; $i <= $current_year; $i++) @if (isset($rekap_skripsi[$i])) <td class="point rekap-skripsi" data-angkatan="{{ $i }}" data-status="Sudah">Sudah</td>
    ...
    <tr>
      @for ($i = $current_year - 6; $i <= $current_year; $i++) @if (isset($rekap_skripsi[$i])) <td class="point rekap-skripsi" data-angkatan="{{ $i }}" data-status="Sudah">{{ $rekap_skripsi[$i]["sudah_skripsi"] }}</td>
