...
<div class="row d-flex flex-column gx-4 gy-4 mb-2">
  ...
  <div class="col-md-4 col-sm-6 d-flex flex-column w-100col-md-4 col-sm-6 d-flex flex-column w-100">
  ...
  <div class="col-md-4 col-sm-6 d-flex flex-column w-100">
    <a href="/rekapMhsPerwalian" style="text-decoration: none">
      <div class="card bg-body-tertiary d-flex justify-content-center align-items-center text-center py-2 h-100">
        ...
        <i class="bi bi-file-earmark-ruled text-secondary" style="font-size:70px;"></i>
      </div>
    </a>
  </div>
</div>
